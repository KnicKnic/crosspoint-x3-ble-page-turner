#!/usr/bin/env python3
"""Preflight idlefix15 before attempting to flash the X3."""
...
def main() -> int:
    ...
    failures: list[str] = []
    steps = [
        ("local verifier", [sys.executable, "scripts/verify_x3_ble_idlefix15.py"], None,
         "All local idlefix15 checks passed"),
        ("firmware image-info", [sys.executable, "scripts/inspect_x3_ble_firmware_image.py"],
         {"X3_BLE_IMAGE_LABEL": "idlefix15", "X3_BLE_FIRMWARE_BIN": BIN},
